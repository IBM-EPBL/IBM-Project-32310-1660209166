...
API_KEY = "qwgXJFbBRzeK7VrTO9mnmGPjeNJOchWfASyjL-B6LO-U"
...
def y_predict():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/21e4b8df-05d1-4dc8-bbcd-b79874021e08/predictions?version=2022-11-06', json=payload_scoring,headers={'Authorization': 'Bearer ' + mltoken})
    print("Scoring response")
    predictions = response_scoring.json()
    output =  predictions['predictions'][0]['values'][0][0]
    print(output)
    return render_template('booking.html',ypred="The resale value predicted is $  "+str(output))
